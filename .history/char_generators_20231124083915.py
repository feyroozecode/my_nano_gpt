...
sample_txt = "bonjour monsieur ali"
print("BEFORE ENCODE => new text is : ", sample_txt)

encode_str = encode(sample_txt)
print("AFTER ENCODE => the new encoded is ", encode_str)

decoded_str = decode(encode_str)
print("FINAL DECODE IT => the text is =", decoded_str)